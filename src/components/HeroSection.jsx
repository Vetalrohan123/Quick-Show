...
const HeroSection = () => {
  ...
  return (
    ...
    px-6 md:px-16 lg:px-36 bg-[url("/backgroundImage.png")] bg-green bg-center h-screen'>
        ...
        cities rode on wheels and consume each other to survive, two people meet in 
        London and try to stop a conspiracy.</p>
        <button onClick={()=> navigate('/movies')} className='flex items-center 
        gap-1 px-6 py-3 text-sm bg-primary
