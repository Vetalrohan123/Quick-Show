  ...
  return (
    <div id='dateSelect' className='pt-30'>
      ...
      relative p-8 bg-primary/10 border border-primary/20 rounded-lg'>
            ...
            <div className='flex items-center gap-6 text-sm mt-5'>
                ...
                <span className='grid grid-cols-3 md:flex flex-wrap md:max-w-lg gap-4'>
                    {Object.keys(dateTime).map((date)=>(
                        <button onClick={()=> setselected(date)} key={date} className={`flex fex-col items-center 
        ...
        <button onClick={onBookHandler} className='bg-primary text-white px-8 py-2 rounded hover:bg-primary/90 
