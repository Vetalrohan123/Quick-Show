  ...
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden">
      ...
      <div className='relative mt-6'>
        ...
        className='mx-auto max-w-full' width="960px" height="549px" />
      </div>
     ...
     <div className='group grid grid-cols-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
        {dummyTrailers.map((trailer)=>(
            ...
            hover:-translate-y-1 durtion-300 transition max-md:h-60 md:max-h-60 cursor-pointer'
            onClick={()=> setCurrentTrailer(trailer)}>
                ...
                left-1/2 w-5 md:w-8 hh-5 md:h-12 transform -translate-x-1/2
                -translate-y-1/2'/>
