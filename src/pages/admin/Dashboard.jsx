...
const Dashboard = () => {
  ...
  return (
    <>
          ...
          <Title text1="Admin" text2="Dashboard" className="m-0 p-0" />
        ...
        <div className='relative flex flex-wrap gap-4 mt-2'>
          ...
          <div className='flex flex-wrap gap-4 w-full'>
            {dashboardCards.map((card, index) => {
              ...
              return (
                <div key={index} className='flex items-center justify-between px-4 py-3 bg-primary/10 border border-primary/20 rounded-md w-full max-w-xs'>
                  <div>
